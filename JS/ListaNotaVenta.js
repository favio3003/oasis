...
function CargarvalorCantidadoesmodal() {
    ...
    if (idProducto == 0) {
        ...
        $.each(_Productos, function (index, elemento) {
            if (elemento.IdProducto == idProducto) {
                ...
                var x = parseInt($("#CantidaDetalle").val());
                ...
                $("#PrecioDetalle").append("Bs. " + PrecioProducto);
                $("#PrecioDetalle").val(PrecioProducto);

                $("#txtTotal").append("Bs. " + PrecioProducto * x);
                $("#txtTotal").val(PrecioProducto * x);
...
function CargarvalorProductoesmodal() {
    ...
    if (idProducto == 0) {
        ...
        $.each(_Productos, function (index, elemento) {
            if (elemento.IdProducto == idProducto) {
                ...
                $("#CantidaDetalle").attr("max", elemento.Cantidad);
                $("#CantidaDetalle").val(1);
                ...
                $("#txtTotal").append("Bs. " + PrecioProducto * 1);
                $("#txtTotal").val(PrecioProducto * 1);
